...
const rawRules: RawRule[] = [
    ...
    deprecated: '1.3',
    removed: '1.9',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*browser\b`,
  ...
  },
  {
    ...
    type: 'property',
    deprecated: '1.3',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*boxModel\b`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '1.7',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*sub\s*\(`,
  ...
  },
  {
    ...
    type: 'property',
    deprecated: '1.9',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*support\b`,
  ...
  },
  {
    ...
    label: '.attr("disabled|checked|selected|readonly")',
    kind: 'recommended',
    type: 'property',
    deprecated: '1.6',
    pattern: String.raw`\.attr\s*\(\s*(['"])(?:disabled|checked|selected|readonly)\1`,
    docsUrl: 'https://api.jquery.com/attr/',
    categoryUrl: 'https://api.jquery.com/attr/',
    replacement: 'Use .prop(...) for disabled, checked, selected and readonly states.',
  ...
  },
  {
    ...
    type: 'property',
    deprecated: '1.6',
    pattern: String.raw`\.removeAttr\s*\(\s*(['"])(?:disabled|checked|selected|readonly)\1\s*\)`,
    docsUrl: 'https://api.jquery.com/removeAttr/',
    categoryUrl: 'https://api.jquery.com/removeAttr/',
    replacement: 'Use .prop("...", false) for disabled, checked, selected and readonly states.',
    replacementUrl: 'https://api.jquery.com/prop/'
  },
  {
    id: 'ready-event-on',
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.0',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*parseJSON\s*\(`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.0',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*unique\s*\(`,
  ...
  },
  {
    ...
    type: 'property',
    deprecated: '3.0',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*fx\s*\.\s*interval\b`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.2',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*holdReady\s*\(`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.2',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*isArray\s*\(`,
  ...
  {
    id: 'focus-event',
    label: '.focus() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.focus\s*\(`,
    docsUrl: 'https://api.jquery.com/focus/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("focus", handler) or .trigger("focus") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  {
    id: 'keydown-event',
    label: '.keydown() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.keydown\s*\(`,
    docsUrl: 'https://api.jquery.com/keydown/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("keydown", handler) or .trigger("keydown") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  {
    id: 'keypress-event',
    label: '.keypress() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.keypress\s*\(`,
    docsUrl: 'https://api.jquery.com/keypress/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("keypress", handler) or .trigger("keypress") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  {
    id: 'keyup-event',
    label: '.keyup() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.keyup\s*\(`,
    docsUrl: 'https://api.jquery.com/keyup/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("keyup", handler) or .trigger("keyup") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  {
    id: 'mouseout-event',
    label: '.mouseout() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.mouseout\s*\(`,
    docsUrl: 'https://api.jquery.com/mouseout/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("mouseout", handler) or .trigger("mouseout") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  {
    id: 'mouseover-event',
    label: '.mouseover() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.mouseover\s*\(`,
    docsUrl: 'https://api.jquery.com/mouseover/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("mouseover", handler) or .trigger("mouseover") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  ...
  {
    id: 'resize-event',
    label: '.resize() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.resize\s*\(`,
    docsUrl: 'https://api.jquery.com/resize/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("resize", handler) or .trigger("resize") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  {
    id: 'scroll-event',
    label: '.scroll() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.scroll\s*\(`,
    docsUrl: 'https://api.jquery.com/scroll/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("scroll", handler) or .trigger("scroll") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  {
    id: 'submit-event',
    label: '.submit() event shorthand',
    type: 'event',
    deprecated: '3.3',
    pattern: String.raw`\.submit\s*\(`,
    docsUrl: 'https://api.jquery.com/submit/',
    categoryUrl: 'https://api.jquery.com/category/deprecated/deprecated-3.3/',
    replacement: 'Use .on("submit", handler) or .trigger("submit") instead.',
    replacementUrl: 'https://api.jquery.com/on/',
    ambiguous: true,
    notes: 'This is only for the event shorthand.'
  },
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.3',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*isWindow\s*\(`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.3',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*now\s*\(`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.3',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*proxy\s*\(`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.3',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*type\s*\(`,
  ...
  },
  {
    ...
    type: 'utility',
    deprecated: '3.5',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*trim\s*\(`,
  ...
  },
  {
    ...
    type: 'deferred',
    deprecated: '3.7',
    pattern: String.raw`\b(?:\$jq|jQuery|JQuery|\$)\s*\.\s*Deferred\s*\.\s*getStackHook\s*\(`,
